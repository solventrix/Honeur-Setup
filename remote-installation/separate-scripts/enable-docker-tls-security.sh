...
echo '{"name":"honeur-studio","users":["honeur-studio"],"actions":["container_create","container_inspect","container_logs","container_start","network_connect"]}' >> $CERTIFICATE_FOLDER/policy.json
