...
then
    ...
    curl -fsSL https://raw.githubusercontent.com/solventrix/Honeur-Setup/release/1.10/OMOPCDMDBIndexesAndContraints/docker-compose.yml --output docker-compose.yml
