...
echo "DATA_SET=AIDA" >> data-quality-pipeline.env
echo "ORGANIZATION=AIDA" >> data-quality-pipeline.env
...
echo "SHARED_SCRIPT_VERSION_UUID=2661ee6e-c099-42a9-a5dd-47665c2b2014" >> data-quality-pipeline.env
