...
class Globals:
    therapeutic_areas:Dict[str, TherapeuticArea] = {
        ...
        "Lupus": TherapeuticArea('lupus', '#0794e0', '#002562', 'portal-uat.lupusnet.org', 'catalogue-uat.lupusnet.org', 'distributed-analytics-uat.lupusnet.org', 'cas-uat.lupusnet.org', Registry('harbor-uat.lupusnet.org', 'lupus'), ['Janssen', 'LupusTestOrg1', 'LupusTestOrg2', 'LupusTestOrg3', 'LupusTestOrg4', 'LupusTestOrg5', 'LupusTestOrg6'])
    }
