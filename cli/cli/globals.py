...
class Globals:
    ...
    therapeutic_areas:Dict[str, TherapeuticArea] = {
        "HONEUR": TherapeuticArea('honeur', '#0794e0', '#002562', 'portal-uat.honeur.org', 'catalogue-uat.honeur.org', 'distributed-analytics-uat.honeur.org', 'cas-uat.honeur.org', Registry('harbor-uat.honeur.org', 'honeur'), ['CHU Toulouse HAL', 'UHL', 'DOS', 'CLLEAR', 'RMG', 'iOMEDICO', 'OIS', 'EMMOS', 'Janssen', 'EY', 'ZOL', 'HOPE', 'Security Scan', 'TestOrg1', 'TestOrg2', 'TestOrg3', 'TestOrg4', 'TestOrg5', 'TestOrg6']),
