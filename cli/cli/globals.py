...
class Globals:
    ...
    all_questions:Dict[str,Question] = {
        ...
        'feder8.local.host.ssl-cert-directory': SingleChoiceQuestion('Enter the folder containing the certificates to enable HTTPS? This should be a folder containing feder8.crt and feder8.key certificate generated by your certificate authority', 'FEDER8_CURRENT_DIRECTORYFEDER8_DIRECTORY_SEPARATORcertificatesFEDER8_DIRECTORY_SEPARATORssl'),
