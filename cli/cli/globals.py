...
class Globals:
    ...
    all_questions:Dict[str,Question] = {
        ...
        'feder8.local.datasource.password': SingleChoiceQuestion('Enter password for feder8 database user?', 'FEDER8_RANDOM_PASSWORD'),
        'feder8.local.datasource.admin-password': SingleChoiceQuestion('Enter password for feder8_admin database user?', 'FEDER8_RANDOM_PASSWORD'),
        ...
        'feder8.local.db.cdm-version': MultipleChoiceQuestion('Select the OMOP CDM version to install', [CdmVersion.v5_3_1.value, CdmVersion.v5_4.value]),
    }
