...
class Globals:
    therapeutic_areas:Dict[str, TherapeuticArea] = {
        "HONEUR": TherapeuticArea('honeur', '#0794e0', '#002562', 'portal.honeur.org', 'catalogue.honeur.org', 'distributed-analytics.honeur.org', 'cas.honeur.org', Registry('harbor.honeur.org', 'honeur'), ['CCL','CHU Dijon','CHU Lille','CHU Montpellier','CHU Toulouse HAL','CLLEAR','DOS','EMMOS','GMV','iOMEDICO','Janssen','OIS','Oncotyrol','RMG','UHL']),
