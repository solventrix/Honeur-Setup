...
class Environment:
    ...
    configuration_key_question_map = {
        ...
        'feder8.local.datasource.password': 'Enter password for FEDER8_THERAPEUTIC_AREA database user',
        'feder8.local.datasource.admin-password': 'Enter password for FEDER8_THERAPEUTIC_AREA_admin database user'
    }
