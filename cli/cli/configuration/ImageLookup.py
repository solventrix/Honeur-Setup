...
def get_local_portal_image_name_tag(therapeutic_area_info):
    return get_image_name_tag(therapeutic_area_info, 'local-portal', '2.0.14')
...
def get_distributed_analytics_remote_image_name_tag(therapeutic_area_info):
    return get_image_name_tag(therapeutic_area_info, 'distributed-analytics', 'remote-2.0.7')


def get_feder8_studio_image_name_tag(therapeutic_area_info):
    return get_image_name_tag(therapeutic_area_info, 'feder8-studio', '2.0.14')
...
def get_disease_explorer_image_name_tag(therapeutic_area_info):
    return get_image_name_tag(therapeutic_area_info, 'disease-explorer', 'latest', restricted=True)
...
def get_task_manager_image_name_tag(therapeutic_area_info):
    return get_image_name_tag(therapeutic_area_info, 'task-manager', '2.0.5')


def get_nginx_image_name_tag(therapeutic_area_info):
    return get_image_name_tag(therapeutic_area_info, 'nginx', '2.0.12')
