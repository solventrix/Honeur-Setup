...
curl -fsSL https://raw.githubusercontent.com/solventrix/Honeur-Setup/develop/local-installation/separate-scripts/start-source-creation.cmd --output start-source-creation.cmd
SET FEDER8_SHARED_SECRETS_VOLUME_NAME=shared-qa
