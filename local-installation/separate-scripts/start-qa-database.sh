...
curl -fsSL https://raw.githubusercontent.com/solventrix/Honeur-Setup/release/1.9/local-installation/separate-scripts/start-postgres.sh --output start-postgres.sh
...
curl -fsSL https://raw.githubusercontent.com/solventrix/Honeur-Setup/release/1.9/local-installation/separate-scripts/start-source-creation.sh --output start-source-creation.sh
