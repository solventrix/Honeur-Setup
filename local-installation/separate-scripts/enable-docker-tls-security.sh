...
echo '{"name":"honeur-studio","users":["feder8"],"actions":["container_create","container_inspect","container_logs","container_start","network_connect"]}' >> $CERTIFICATE_FOLDER/policy.json
