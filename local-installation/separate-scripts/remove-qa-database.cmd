...
curl -fsSL https://raw.githubusercontent.com/solventrix/Honeur-Setup/release/1.9/local-installation/separate-scripts/start-source-deletion.cmd --output start-source-deletion.cmd
