...
install.packages("https://github.com/solventrix/Honeur-Setup/raw/release/1.10.1/DataQualityDashboard/DataQualityDashboard_1.0.0.tar.gz", repos = NULL, type = "source", INSTALL_opts = c('--no-multiarch'))
